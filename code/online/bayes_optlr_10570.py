...
用法::
    ...
    python bayes_optlr_10570.py --max-iter 50 --init-points 15
    python bayes_optlr_10570.py --max-iter 30 --plateau-patience 15
...
def main() -> int:
    ...
    parser.add_argument(
        "--gun-config",
        type=Path,
        default=ROOT / "gun_modbus_config_bayes_105_70.json",
        help="105/70 专用电子枪配置",
    )
