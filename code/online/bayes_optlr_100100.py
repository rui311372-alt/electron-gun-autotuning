...
用法::
    ...
    python bayes_optlr.py --max-iter 50 --init-points 15
    python bayes_optlr.py --max-iter 30 --plateau-patience 15
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="每个 Ua/Ia 组合最多候选组数，范围 30--50（含舍弃组）",
    )
    ...
    parser.add_argument("--gun-config", type=Path, default=ROOT / "gun_modbus_config_bayes_100_100.json")
